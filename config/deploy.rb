...
role :web, "fc.com"                          # Your HTTP server, Apache/etc
role :app, "fc.com"                         # This may be the same as your `Web` server
role :db,  "fc.com"   , :primary => true # This is where Rails migrations will run
